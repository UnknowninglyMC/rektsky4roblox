...
local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/UnknowninglyMC/rektsky4roblox/main/NewRektskyUiLib.lua"))()
...
pcall(function()
    whiteliststhing = loadstring(game:HttpGet("https://raw.githubusercontent.com/UnknowninglyMC/rektsky4roblox/main/whitelist.lua"))()
end)
...
local function getcustomassetfunc(path)
    if not betterisfile(path) then
        ...
        local req = requestfunc({
            Url = "https://raw.githubusercontent.com/UnknowninglyMC/rektsky4roblox/main/"..path:gsub("rektsky/sound/mc", "sound/mc"),
            Method = "GET"
        })
...
local function getcustomassetthingylol(path)
    if not betterisfile(path) then
        ...
        local req = requestfunc({
            Url = "https://raw.githubusercontent.com/UnknowninglyMC/rektsky4roblox/main/"..path:gsub("rektsky/assets", "assets"),
            Method = "GET"
        })
        writefile(path, req.Body)
    end
